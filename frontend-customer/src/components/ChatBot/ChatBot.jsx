    ...
    const sendMessage = async (overrideText) => {
        ...
        try {
            ...
            setMessages((prev) => [
                ...
                {
                    role: "bot",
                    text: "😋 I recommend trying our delicious Hyderabadi Dum Biryani or a Classic Beef Burger today! 🍔\n\n🍴 Popular on our menu:\n• Hyderabadi Dum Biryani\n• Classic Beef Burger\n• Rich Dark Chocolate Cake",
                },
            ]);
        } finally {
            setLoading(false);
        ...
        <>
            ...
            {isOpen && (
                <div className="chatbot-window">
                    ...
                    {/* Suggestion Pills Wrapper with Scroll Arrows */}
                    <div className="chatbot-suggestions-wrapper">
                        <button 
                            type="button" 
                            className="chatbot-nav-arrow left" 
                        ...
                        <button 
                            type="button" 
                            className="chatbot-nav-arrow right" 
