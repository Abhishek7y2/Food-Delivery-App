    ...
    public ResponseEntity<?> login(@RequestBody AuthenticationRequest request) {
        try {
            ...
            try {
                ...
                System.out.println("Dev Mode Notice: SMTP skipped (" + mailEx.getMessage() + "). Login OTP for " + userEntity.getEmail() + " is: " + otp);
            }

            return ResponseEntity.ok(java.util.Map.of("message", "OTP sent to email", "requiresOtp", true, "devOtp", otp));
        } catch (Exception e) {
            e.printStackTrace();
