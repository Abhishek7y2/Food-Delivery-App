...
public class FoodController {
    ...
    public FoodResponse addFood(@RequestPart("food") String foodString,
        ...
        try {
            //request = objectMapper.readValue(foodString, FoodRequest.class);
            foodRequest = objectMapper.readValue(foodString, FoodRequest.class); // FIX: was 'FoodRequest request = ...' creating a new local variable that dies in try block — changed to assign to 'foodRequest' declared above
